                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">All Damage Products
                                            ...
                                            <a href="{{URL::to('/product-dmg-export')}}" class="btn btn-success btn-sm pull-right">Excel</a>
                                            &nbsp;&nbsp;  <a href="{{URL::to('/product-dmg-export-pdf')}}" class="btn btn-danger btn-sm pull-right">PDF</a>&nbsp;&nbsp;
