                            ...
                            <div class="row"> 
                                <div class="col-md-6"> 
                                    <div class="form-group"> 
                                        ...
                                        <input name="emp_id" type="text" class="form-control" id="field-1" placeholder="John"> 
                                    </div> 
                                </div> 
                                <div class="col-md-6"> 
                                    <div class="form-group"> 
                                        <label for="field-2" class="control-label">Employee Name</label> 
                                        <input name="emp_name" type="text" class="form-control" id="field-2" placeholder="Doe"> 
                                    </div> 
                                </div> 
                            </div> 
                             ...
                             <div class="row"> 
                                <div class="col-md-6"> 
                                    <div class="form-group"> 
                                        ...
                                        <input name="emp_designation" type="text" class="form-control" id="field-1" placeholder="John"> 
                                    </div> 
                                </div> 
                                <div class="col-md-6"> 
                                    <div class="form-group"> 
                                        <label for="field-2" class="control-label">Joining Date</label> 
                                        <input name="join_date" type="text" class="form-control" id="field-2" placeholder="Doe"> 
                                    </div> 
                                </div> 
                            </div> 
                            ...
                            <div class="row"> 
                                <div class="col-md-6"> 
                                    <div class="form-group"> 
                                        ...
                                        <input name="emp_department" type="text" class="form-control" id="field-1" placeholder="John"> 
                                    </div> 
                                </div> 
