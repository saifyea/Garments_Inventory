                                ...
                                <div class="tab-content"> 
                                    <div class="tab-pane active" id="general_items"> 
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                               <form action="{{URL::to('/de-reports-genersl-items')}}" method="GET">
                                                @csrf
                                            
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <h3 class="panel-title" >Delevery Report of General Itmes</h3>
                                                    </div>
                                    ...
                                    <div class="tab-pane " id="fabrics"> 
                                        <div class="row">
                                            <div class="col-md-2"></div>
                                            <div class="col-md-8">
                                               <form action="{{URL::to('/de-reports-fabrics')}}" method="GET">
                                                @csrf
                                            
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <h3 class="panel-title" >Delevery Fabrics Reports</h3>
                                                    </div>
                                                    <div class="panel-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                    ...
                                    <div class="tab-pane" id="threads"> 
                                       <div class="row">
                                            <div class="col-md-2"></div>
                                            <div class="col-md-8">
                                               <form action="{{URL::to('/de-reports-thread')}}" method="GET">
                                                @csrf
                                            
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <h3 class="panel-title" >Delevery Thread Reports</h3>
                                                    </div>
                                                    <div class="panel-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                    ...
                                    <div class="tab-pane" id="chamicals"> 
                                        <div class="row">
                                            <div class="col-md-2"></div>
                                            <div class="col-md-8">
                                               <form action="{{URL::to('/de-reports-chamical')}}" method="GET">
                                                @csrf
                                            
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <h3 class="panel-title" >Delevery Chamical Reports</h3>
                                                    </div>
                                                    <div class="panel-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                    ...
                                    <div class="tab-pane" id="accessories"> 
                                        <div class="row">
                                            <div class="col-md-2"></div>
                                            <div class="col-md-8">
                                               <form action="{{URL::to('/de-reports-accessories')}}" method="GET">
                                                @csrf
                                            
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <h3 class="panel-title" >Delevery Accessories Reports</h3>
                                                    </div>
                                                    <div class="panel-body">
                                                        <div class="row">  
                                                            <div class="col-md-3">
