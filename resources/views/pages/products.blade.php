                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">All Products<a href="{{URL::to('/product-export')}}" class="btn btn-success btn-sm pull-right">Excel</a>
                                            <a href="{{URL::to('/pdf-product')}}" class="btn btn-danger btn-sm pull-right">PDF</a>
                                            &nbsp;&nbsp; <button class="btn btn-sm pull-right btn-info waves-effect waves-light" data-toggle="modal" data-target="#con-close-modal1">Import</button>
                                        </h3>
                                                ...
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="gradeX">
                                                            ...
                                                            <td class="actions">
                                                                <a href="{{URL('/single-product/'.$row->prod_code)}}" class="on-default view-row"><i class="fa fa-eye fa-2x"></i></a>                     
                                                                 &nbsp; &nbsp;
                                                                <a href="{{URL('/edit-product/'.$row->prod_code)}}" class="on-default edit-row"><i class="fa fa-pencil fa-2x"></i></a>
