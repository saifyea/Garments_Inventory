                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Chamicals in Stock<a href="{{URL::to('/docket-export')}}" class="btn btn-success btn-sm pull-right">Excel</a>
                                            <a href="{{URL::to('/pdf-issue-thread')}}" class="btn btn-danger btn-sm pull-right">PDF</a>
                                            &nbsp;&nbsp; <a  href="{{URL::to('/add-fabric')}}" class="btn btn-sm pull-right btn-info waves-effect waves-light">Add chamical</a>
                                        </h3>
                                                ...
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="gradeX">
                                                            ...
                                                            <td class="actions">
                                                                <a href="{{URL('/singleChamical/'.$row->chamical_id)}}" class="on-default view-row"><i class="fa fa-eye fa-2x"></i></a>                     
                                                                 &nbsp; &nbsp;
                                                                <a href="{{URL('/edit-chamical/'.$row->chamical_id)}}" class="on-default edit-row"><i class="fa fa-pencil fa-2x"></i></a>
