                                    ...
                                    <div class="panel-body print">
                                        <div class="clearfix">
                                            ...
                                            <div class="pull-right">
                                                <h4>Invoice # <br>
                                                    <strong>{{date('yy')}}-s{{date('m')}}-{{date('d')}}{{$order_data->order_id}}</strong>
                                                </h4>
                                            </div>
                                        </div>
                                        <hr>
                                       ...
                                       {{--  <div class="row" style="border-radius: 0px;">
                                        ...
                                        <div class="hidden-print">
                                            <div class="pull-right">
                                                ...
                                                <a href="{{URL::to('/issued-Accessories')}}" class="btn btn-primary waves-effect waves-light" >Back</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
