                ...
                <div class="col-md-7">
                    <div class="panel panel-default">
                        <div class="panel-heading" style="background-color:#33DAFF">
                            <h3 class="panel-title ">Select Accessories</h3>
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            @foreach($prod_data as $row)
                                                <tr class="gradeX">
                                                    <form method="POST" action="{{URL('/acc_add_cart')}}" enctype="multipart/form-data">
                                                    @csrf
                                                    <input type="hidden" name="id" value="{{$row->accessories_id}}">
                                                    <input type="hidden" name="name" value="{{$row->accessories_name}}">
                                                    <input type="hidden" name="qty" value="1">
                                                    <input type="hidden" name="weight" value="1">
                                                    <input type="hidden" name="price" value="{{$row->acc_price}}">
                                                    
                                                    <td >{{$row->accessories_id}}</td>
                                                    <td >{{$row->accessories_name}}</td>
                                                    <td >{{$row->ttl_recv}}</td>
                                                    <td><img src="{{$row->acc_photo}}" style="width:50px; height:50px;"></td>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                         ...
                                         <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                         <form action="{{URL('/acc_update-cart/'.$items->rowId)}}" method="POST">
                                                            @csrf
                                                            <div class="input-group " style="width: 110px">
                                                            <input type="number" name="qty" value="{{$items->qty}}" class="form-control">
                                                            <input type="hidden" name="acc_id" value="{{$items->id}}">
                                   ...
                                   {{--      <div class="pricing-header bg-info">
                                        ...
                                        <form action="{{URL::to('/create-Accessories-invoice')}}" method="POST">
                                            @csrf
                                                ...
                                                <div class="panel panel-default">
                                                 <div class="panel-heading">
                                                    ...
                                                    @foreach($prod_data as $row)
                                                        <input type="hidden" name="accessories_id" value="{{$row->accessories_id}}">
