                ...
                <div class="col-md-7">
                    <div class="panel panel-default">
                        <div class="panel-heading" style="background-color:#33DAFF">
                            <h3 class="panel-title ">Select Fabrics</h3>
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            @foreach($prod_data as $row)
                                                <tr class="gradeX">
                                                    <form method="POST" action="{{URL('/fa_add_cart')}}" enctype="multipart/form-data">
                                                    @csrf
                                                    <input type="hidden" name="id" value="{{$row->fabric_code}}">
                                                    <input type="hidden" name="name" value="{{$row->style_no}}">
                                                    <input type="hidden" name="qty" value="1">
                                                    <input type="hidden" name="weight" value="1">
                                                    <input type="hidden" name="price" value="{{$row->febric_price}}">
                                                    ...
                                                    <td><img src="{{$row->fabric_photo}}" style="width:50px; height:50px;"></td>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                         ...
                                         <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                         <form action="{{URL('/fa_update_cart/'.$items->rowId)}}" method="POST">
                                                            @csrf
                                                            <div class="input-group " style="width: 110px">
                                                            <input type="number" name="qty" value="{{$items->qty}}" class="form-control">

                                                            <input type="hidden" name="fabric_code" value="{{$items->id}}">
                                   ...
                                   {{--      <div class="pricing-header bg-info">
                                        ...
                                        <form action="{{URL::to('/create-fabric-invoice')}}" method="POST">
                                            @csrf
                                                                              
                                            </div> <!-- end Pricing_card -->
                                                <div class="panel panel-default">
                                                 <div class="panel-heading">
                                                     <h3 class="panel-title" >requisition No.<input type="text" name="order_no" class="pull-right" required="" style="height: 25px"></h3>
                                                    @foreach($prod_data as $row)
                                                        <input type="hidden" name="color" value="{{$row->color}}">
                                                        <input type="hidden" name="buyer" value="{{$row->buyer}}">
