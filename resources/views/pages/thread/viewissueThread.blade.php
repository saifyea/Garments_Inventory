                                       ...
                                       {{--  <div class="row" style="border-radius: 0px;">
                                        ...
                                        <div class="hidden-print">
                                            <div class="pull-right">
                                                ...
                                                <a href="#"  id="print" class=" button b1 btn btn-inverse waves-effect waves-light"><i class="fa fa-print"></i></a>
                                                <a href="{{URL::to('/issued-thread')}}" class="btn btn-primary waves-effect waves-light" >Back</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
